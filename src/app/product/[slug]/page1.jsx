...
export default function ProductPage() {
  ...
  if (!product) {
    return (
      <main className="min-h-[70vh] bg-[#FAFAFA] px-5 py-24 text-black">
        <div className="mx-auto max-w-3xl text-center">
          <p className="font-oxanium text-xs font-bold uppercase tracking-[0.3em] text-[#E52323]">
            Product not found
          </p>

          <h1 className="font-oxanium mt-4 text-4xl font-bold uppercase tracking-tight">
          ...
          <Link
            href="/products"
            className="font-oxanium mt-8 inline-flex items-center gap-2 rounded-lg bg-[#E52323] px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition hover:bg-[#ff2b2b]"
          >
  ...
  return (
    <>
      <main className="font-oxanium min-h-screen bg-[#FAFAFA] font-semibold text-[#111111]">
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(420px,0.92fr)] lg:items-start lg:gap-14 xl:gap-20">
            <div className="min-w-0 lg:sticky lg:top-24">
              <div className="flex gap-3 sm:gap-4">
                    ...
                    {product.images.map(
                      (image, index) => (
                        ...
                        >
                          <Image
                            src={image}
                            alt={`${product.shortName} thumbnail ${
                              index + 1
                            }`}
                            fill
                ...
                <div className="relative aspect-[1/1] w-full min-w-0 overflow-hidden rounded-2xl border border-[#E5E5E5] bg-white sm:aspect-square">
                  {discountPercentage >
                    0 && (
                  ...
                  <button
                    ...
                    className="absolute right-3 top-3 z-20 flex h-9 w-9 items-center justify-center rounded-full border border-[#D4D4D4] bg-[#0b0b0b]/90 text-white backdrop-blur transition hover:border-[#E52323] hover:text-[#E52323] sm:right-5 sm:top-5 sm:h-11 sm:w-11"
                        ...
                        >
                          <div className="relative h-full w-full">
                            <Image
                              ...
                              className="object-contain p-4 sm:p-10 lg:p-16"
                              sizes="(max-width: 640px) calc(100vw - 40px), (max-width: 1024px) calc(100vw - 64px), 55vw"
                            />
                          </div>
                        </SwiperSlide>
                      )
                  ...
                  {product.images.length >
                    ...
                    <>
                      <button
                        ...
                        className="absolute left-2 top-1/2 z-30 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-[#D4D4D4] bg-white/90 text-black shadow-md transition hover:border-[#E52323] hover:bg-[#E52323] hover:text-white sm:left-4 sm:h-10 sm:w-10"
                      ...
                      <button
                        type="button"
                        onClick={nextImage}
                        className="absolute right-2 top-1/2 z-30 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-[#D4D4D4] bg-white/90 text-black shadow-md transition hover:border-[#E52323] hover:bg-[#E52323] hover:text-white sm:right-4 sm:h-10 sm:w-10"
            ...
            <div>
              ...
              <h1 className="mt-3 font-bebas text-3xl leading-[1.05] tracking-tight sm:text-4xl xl:text-[46px]">
                {product.name}
              </h1>
              ...
              <div className="mt-6 flex flex-col gap-3">
                ...
                <div className="flex w-full flex-col gap-3 sm:flex-row">
                  <button
                    ...
                    className="flex h-14 w-full items-center justify-center gap-2 rounded-lg bg-[#E52323] px-6 text-sm font-black uppercase tracking-wide text-white transition hover:bg-[#ff2b2b] disabled:cursor-not-allowed disabled:opacity-40 sm:flex-1"
                  >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-[#737373]">
                      ...
                      secure payments and reliable
                      delivery from Cost2Cost
                      Supplement.
                    </p>
                  </div>
                </div>
      ...
      {isZoomOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/95 p-5">
          <button
            ...
            className="absolute right-5 top-5 z-10 flex h-12 w-12 items-center justify-center rounded-full border border-[#D4D4D4] bg-white text-black transition hover:border-[#E52323] hover:text-[#E52323]"
