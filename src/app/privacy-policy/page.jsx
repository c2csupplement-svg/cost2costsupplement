...
const getPrivacyPolicySEO = cache(async () => {
  try {
    const response = await getPageSeo("privacy-policy");
    ...
    console.error("Privacy Policy page SEO error:", error);
    return null;
  }
});

export async function generateMetadata() {
  const seo = await getPrivacyPolicySEO();
