...
const getExchangeSEO = cache(async () => {
  try {
    const response = await getPageSeo("returns-exchange");
    ...
    console.error("Returns Exchange page SEO error:", error);
    return null;
  }
});

export async function generateMetadata() {
  const seo = await getExchangeSEO();

  return getSEOMetadata(seo);
}

export default async function ReturnExchangePolicy() {
