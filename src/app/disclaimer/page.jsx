...
const getDisclaimerSEO = cache(async () => {
  try {
    const response = await getPageSeo("disclaimer");
    ...
    console.error("Disclaimer page SEO error:", error);
    return null;
  }
});

export async function generateMetadata() {
  const seo = await getDisclaimerSEO();
