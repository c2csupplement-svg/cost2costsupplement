...
if (totalCount) {
  const existingRatingTotal = baseRating * existingCount;
...
try {
  ...
  formdata.append("des", reviewText.trim());
  ...
  const newReview = {
    ...
    images: Array.isArray(returnedReview?.images)
  ...
  <div className="mt-7 grid gap-6 md:grid-cols-[280px_1fr]">
    ...
    <div className="rounded-2xl border border-[#E5E5E5] bg-white p-7">
      ...
      <p className="mt-3 text-sm leading-6 text-[#737373]">
        This product currently has {totalReviews} customer
        reviews with an average rating of {averageRating} out
        of 5.
      </p>
